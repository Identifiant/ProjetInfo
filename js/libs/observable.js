/* Observable - Version es6 module (AMD, CommonJS, global) - Ferdinand Piette */
(function(root, factory) {
	if (typeof exports !== 'undefined') { root.Observable = factory(root, exports); } 
	else if (typeof define === 'function' && define.amd) { define([], function() { return factory(root); }); } 
	else { root.Observable = factory(root); }
}(this, function(root) {
